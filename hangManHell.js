...
// Creating hangmanGame object that will house all of our logic and variables.
var hangmanGame = {
  ...
  setupGame: function() {
    ...
    console.log("word in play is " + this.wordInPlay);
  ...
  updateGuesses: function(letter) {
    ...
    if ((this.guessedLetters.indexOf(letter) === -1) && (this.lettersOfTheWord.indexOf(letter) === -1)) {
      ...
      console.log("you have guessed these letters: " + this.guessedLetters.join(", "));
...
// display the word
  ...
  // For example, if we are trying to guess "horse", it might display "h_rs_".
  rebuildWordView: function() {
    ...
    for (var i = 0; i < this.lettersOfTheWord.length; i++) {
      ...
      if (this.matchedLetters.indexOf(this.lettersOfTheWord[i]) !== -1) {
        ...
        console.log("inside rebuildWordView " + wordView);
      }
    ...
    console.log("display of word in play = " + wordView);
...
// make `process.stdin` begin emitting "keypress" events yyyyy q
...
//                 type: "input",
//                 name: "letter",
//                 message: "Press another letter please."
//               },  
